...
- (BOOL)open {
    ...
    if ((ft_error = FT_OpenEx((char *)serialString, FT_OPEN_BY_SERIAL_NUMBER, &ft_handle))) {
        ...
        if ((ft_error = FT_OpenEx((char *)productNameString, FT_OPEN_BY_DESCRIPTION, &ft_handle))) {
