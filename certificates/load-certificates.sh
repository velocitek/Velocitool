...
security import $FOLDER/certificates/developer_id.cer -k $KEY_CHAIN -T /usr/bin/codesign
security import $FOLDER/certificates/certificates.p12 -k $KEY_CHAIN -P $CERT_PASSWORD -T /usr/bin/codesign
